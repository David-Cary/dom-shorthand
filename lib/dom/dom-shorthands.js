...
exports.setNodeContentFromShorthands = exports.applyNodeChangeShorthand = exports.validateDOMShorthand = exports.getNodeContentShorthands = exports.getNodeShorthand = exports.getShorthandContentDescription = exports.shorthandToHTML = exports.shorthandToDOMDescription = exports.addChildNodesToShorthand = exports.DOMDescriptionToShorthand = void 0;
...
function shorthandToHTML(shorthand) {
    ...
    if ('name' in shorthand && 'value' in shorthand) {
        return "".concat(shorthand.name, "=\"").concat(String(shorthand.value), "\"");
    }
    return '';
}
 ...
 */
function getNodeShorthand(source) {
    var description = (0, dom_nodes_1.describeNode)(source);
    var shorthand = DOMDescriptionToShorthand(description);
    return shorthand;
}
exports.getNodeShorthand = getNodeShorthand;
/**
 ...
 */
function getNodeContentShorthands(source) {
    var descriptions = (0, dom_nodes_1.describeNodeList)(source.childNodes);
    var shorthands = descriptions
        .map(function (item) { return DOMDescriptionToShorthand(item); })
        .filter(function (item) { return item != null; });
    return shorthands;
}
exports.getNodeContentShorthands = getNodeContentShorthands;
/**
 ...
 */
function applyNodeChangeShorthand(node, shorthand) {
    var description = shorthandToDOMDescription(shorthand);
    var updatedNode = (0, dom_nodes_1.applyDescribedNodeChanges)(node, description);
    return updatedNode;
}
exports.applyNodeChangeShorthand = applyNodeChangeShorthand;
/**
 ...
 */
function setNodeContentFromShorthands(target, shorthands) {
    var descriptions = shorthands.map(function (shorthand) { return shorthandToDOMDescription(shorthand); });
    (0, dom_nodes_1.setChildNodesFromDescriptions)(target, descriptions);
    return descriptions;
}
exports.setNodeContentFromShorthands = setNodeContentFromShorthands;
