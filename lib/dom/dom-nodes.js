...
function setChildNodesFromDescriptions(node, descriptions) {
    ...
    for (var i = 0; i < descriptions.length; i++) {
        ...
        if ((child === null || child === void 0 ? void 0 : child.nodeName) === description.nodeName) {
            if (child instanceof CharacterData) {
                child.data = (_a = description.nodeValue) !== null && _a !== void 0 ? _a : '';
            }
            else {
                if (child instanceof Element) {
                    var attributes = (_b = description.attributes) !== null && _b !== void 0 ? _b : {};
                    var childAttributeNames = child.getAttributeNames();
                    for (var _i = 0, childAttributeNames_1 = childAttributeNames; _i < childAttributeNames_1.length; _i++) {
                        var name_1 = childAttributeNames_1[_i];
